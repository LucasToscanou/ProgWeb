...
urlpatterns = [
    ...
    path('answer_form/<int:question_list_id>/', views.AnswerFormView.as_view(), name='answer_form'),
    path('form_answered_success/<int:question_list_id>/', views.form_answered_success, name='form_answered_success'),
    ...
    path('delete_form/<int:id>/', views.confirm_delete_form_view, name='delete_form'),
    ...
    path('form_created_success/<int:question_list_id>/', views.form_created_success, name='form_created_success'),
